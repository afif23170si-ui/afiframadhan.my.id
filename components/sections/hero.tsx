...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-[auto] md:min-h-screen flex items-start md:items-center justify-center overflow-hidden py-20 pb-8 md:py-20 pt-24 md:pt-32">
      {/* Grid Background */}
