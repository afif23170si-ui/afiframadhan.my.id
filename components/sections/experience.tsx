              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    className="flex-shrink-0 w-11 h-11 rounded-full overflow-hidden border border-zinc-950/[0.08] bg-zinc-950/[0.05] hover:border-[#44624a]/50 transition-all duration-200"
                    title={exp.company}
                  >
                    <Image
                      src={exp.logo}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                      <div className="space-y-0.5">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1 text-sm md:text-[15px] text-zinc-500 font-medium hover:text-[#8ba888] transition-colors duration-200 group/link"
                        >
                          {exp.company}
