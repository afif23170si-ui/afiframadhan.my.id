        ...
        <div className="relative overflow-hidden mask-gradient-x">
          ...
          >
            {duplicated.map((t, i) => (
              ...
              >
                <div className="h-full rounded-xl border border-zinc-950/[0.07] bg-zinc-50/40 p-5 md:p-6 hover:bg-zinc-50/60 hover:border-zinc-950/[0.11] transition-all duration-300">
                  {/* Company */}
                  ...
                  {/* Quote */}
                  <p className="text-sm text-zinc-600 leading-relaxed mb-6 line-clamp-4">
